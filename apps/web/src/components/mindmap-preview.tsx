...
function PreviewNode({ accent, title, meta, value }: PreviewNodeProps) {
  return (
    <div className="min-w-[220px] rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(8,13,30,0.96),rgba(12,18,38,0.92))] px-4 py-3 text-left shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
...
export function MindmapPreview() {
  return (
    <div className="panel relative h-[440px] overflow-hidden rounded-[28px] p-0">
      <div className="absolute inset-x-0 top-0 z-10 flex items-center justify-between border-b border-white/[0.08] px-5 py-4">
        <div>
